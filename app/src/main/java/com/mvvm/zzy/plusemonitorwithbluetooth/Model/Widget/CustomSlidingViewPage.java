package com.mvvm.zzy.plusemonitorwithbluetooth.Model.Widget;
...
public class CustomSlidingViewPage extends ViewPager {

    private float beforeX;/*上次x坐标*/
    private int mEventType = 0;/*事件种类:0--禁止左右滑动;1--禁止向左滑动;2--禁止向右滑动;3--不禁止滑动*/

    public CustomSlidingViewPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
    }

    public CustomSlidingViewPage(Context context) {
        super(context);
    }
